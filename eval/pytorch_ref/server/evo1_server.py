...
from policies.evo1 import EVO1PolicyPipeline
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-id", type=str, default="MINT-SJTU/Evo1_LIBERO",
        help="HF model id / local checkpoint dir."
    )
    parser.add_argument(
