...
from policies.gr00t_n15.groot.configuration_groot import GrootConfig
from policies.gr00t_n15.groot.groot_n1 import GR00TN15
...
class GrootPolicy(PreTrainedPolicy):
    ...
    def _create_groot_model(self):
        ...
        model = GR00TN15.from_pretrained(
            ...
            # Base GR00T-N1.5-3B is BF16 on disk but HF would upcast it to fp32
            # (~10.9 GB host RAM). Load it bf16 to keep the load-time peak low;
            # the fine-tuned checkpoint is copied in afterwards at the same dtype.
