...
from policies.gr00t_n17.model.modules.dit import AlternateVLDiT, DiT, SelfAttentionTransformer
from policies.gr00t_n17.model.modules.embodiment_conditioned_mlp import (
    CategorySpecificMLP,
...
def get_backbone_cls(config: Gr00tN1d7Config):
    if "nvidia/Cosmos-Reason2" in config.model_name or "Qwen/Qwen3-VL" in config.model_name:
        ...
        from policies.gr00t_n17.model.modules.qwen3_backbone import Qwen3Backbone
